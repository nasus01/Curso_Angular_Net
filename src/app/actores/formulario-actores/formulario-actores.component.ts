...
import { fechaNopudeSerFutura } from '../../compartidos/funciones/validaciones';
  ...
  ngOnInit(): void {
    ...
    form = this.formbuilder.group({
      ...
      fechaNacimiento: new FormControl <Date | null>(null,{
        validators:[Validators.required,fechaNopudeSerFutura()]
      }),
    ...
    obtenerErrorCampoFechaNacimiento(){
      let campo = this.form.controls.fechaNacimiento;
       if(campo.hasError('required')){
        return 'el campo dela fecha es requerido';
      }
