...
export class MapaComponent implements OnInit {
  ...
  @Output()
  coordenandaSeleccionada = new EventEmitter<Coordenada>();
  ...
  options ={
   ...
   zoom:14,
   center: latLng(6.2501193377576225, -75.56625558911965)
  }
  ...
  this.coordenandaSeleccionada.emit({latitud,longitud})
